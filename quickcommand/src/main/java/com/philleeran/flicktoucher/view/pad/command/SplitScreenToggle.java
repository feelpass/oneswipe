...
public class SplitScreenToggle implements Command {
    private Context mContext;

    public SplitScreenToggle(Context context) {
        mContext = context;
    }
    ...
    public void execute() {
        ...
        if (isSet) {
            ...
            intent.putExtra("type", AccessibilityService.GLOBAL_ACTION_TOGGLE_SPLIT_SCREEN);
