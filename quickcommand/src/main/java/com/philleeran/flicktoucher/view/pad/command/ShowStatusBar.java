...
public class ShowStatusBar implements Command {
    @Override
    public void execute() {
        try {
            IBinder binder = ServiceManagerCompat.getService("statusbar");
            Class<?> statusBarClasz = CompatUtils.getClass(binder.getInterfaceDescriptor());
            ...
            Method toggleRecentApps = CompatUtils.getMethod(statusBarClasz, "toggleRecentApps");
