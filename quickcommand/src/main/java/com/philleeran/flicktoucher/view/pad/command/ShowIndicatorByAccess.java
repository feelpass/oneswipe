...
public class ShowIndicatorByAccess implements Command {
    private Context mContext;

    public ShowIndicatorByAccess(Context context) {
        mContext = context;
    }
    ...
    public void execute() {
        ...
        if (isSet) {
            ...
            intent.putExtra("type", AccessibilityService.GLOBAL_ACTION_NOTIFICATIONS);
